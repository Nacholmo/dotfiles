...
our $SCHEMA = [
    ...
    #          NAME            LABEL                ICON
    {cat => ['utility',     'Utilidad', 'applications-utilities']},
    {cat => ['development', 'Desarollo', 'applications-development']},
    {cat => ['education',   'Ciencia',   'applications-science']},
    ...
    {sep => undef},
    {beg => ['Avanzada', 'applications-engineering']},
    ...
    {item => ['xscreensaver-command -lock', 'Bloquear', 'system-lock-screen']},
